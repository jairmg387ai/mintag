...
function CatalogSection({
  ...
  async function handleAdd() {
    ...
    try {
      ...
      setError(e instanceof Error ? e.message : 'Error al agregar la entrada')
    } finally {
      setAdding(false)
    }
  }
  ...
  async function handleRemove(name: string) {
    ...
    try {
      ...
      setError(e instanceof Error ? e.message : 'Error al eliminar la entrada')
    } finally {
...
function AzureActivitySection({
  ...
  async function handleAdd() {
    ...
    try {
      ...
      setError(friendlyCatalogErrorMessage(e, 'Error al agregar la actividad'))
    } finally {
      setAdding(false)
    }
  }
  ...
  async function saveEdit(id: number) {
    ...
    try {
      ...
      setError(friendlyCatalogErrorMessage(e, 'Error al actualizar la actividad'))
    } finally {
      setBusyId(null)
    }
  }
  ...
  async function handleSetDefault(id: number) {
    ...
    try {
      ...
      setError(friendlyCatalogErrorMessage(e, 'Error al establecer la actividad predeterminada'))
    } finally {
      setBusyId(null)
    }
  }
  ...
  async function handleDeactivate(id: number) {
    ...
    try {
      ...
      setError(friendlyCatalogErrorMessage(e, 'Error al desactivar la actividad'))
    } finally {
      setBusyId(null)
    }
  }
                ...
                <>
                  ...
                  {a.is_default ? (
                    ...
                    <button
                      ...
                      aria-label={`Establecer ${a.label} como predeterminada`}
                      style={{ padding: '2px 4px' }}
                    >
                  ...
                  <button
                    ...
                    title={a.is_default ? 'Primero establece otra actividad como predeterminada' : 'Desactivar'}
